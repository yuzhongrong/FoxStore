...
import com.android.mobchat.glide.GlideRoundTransform;
...
//import com.android.mobchat.GlideRoundTransform;
...
public class LoadImageUtils {
	...
	public static void loadImageView(Context context, ImageView imageView, String path, int defResId) {
		ViewGroup.LayoutParams lp = imageView.getLayoutParams();
		GlideApp.with(context).load(new File(path))
				.placeholder(defResId)
				.dontAnimate()
				.transition(DrawableTransitionOptions.withCrossFade())
				.transform(new RoundedCornersTransformation(ResHelper.dipToPx(context, lp.width / 3),0))
				.centerCrop()
				.into(imageView);
	...
	public static void showAvatar(Context context, ImageView imageView, String imgUrl, String defaultResId, int radius) {
		...
		GlideUtil.loadImageViewWithTransform(context
				                             ,imgUrl,
				                             new RoundedCornersTransformation(ResHelper.dipToPx(context, radius),0)
				                             ,imageView);
	}
