...
public class MainActivity extends BaseChatActivity implements View.OnClickListener {
	...
	private void showTabConversation() {
		...
		FoxChatApplication application = (FoxChatApplication) getApplication();
	...
	public void onClick(View v) {
		...
		if (vId == R.id.tvLogin) {
			login();
		} else if (vId == R.id.tabConversation || vId == R.id.tabContacts || vId == R.id.tabMine) {
			if (v.isSelected()) {
				return;
			}
			v.setSelected(true);
